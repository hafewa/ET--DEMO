...
namespace ETModel
{
	...
	public sealed class EventSystem
	{
        ...
        //这个自定义的字典存储  一个特性类型对应的许多个拥有该特性的类型
		...
		public void Add(DLLType dllType, Assembly assembly)
		{
			...
			foreach (Type type in types[typeof(ObjectSystemAttribute)])
			{
                ...
                //Log.Debug("事件系统"+obj.ToString());
             
				switch (obj)
				{
					case IAwakeSystem objectSystem:
                        //Log.Debug("Iwake  "+objectSystem.Type().ToString());
                        //Log.Debug(objectSystem.ToString());
			...
			foreach (Type type in types[typeof(EventAttribute)])
			{
                ...
                Log.Debug("EventAttribute 长度  "+attrs.Length.ToString());
